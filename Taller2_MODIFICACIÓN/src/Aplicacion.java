...
public class Aplicacion {
	...
	public static void main(String[] args) throws IOException {
		...
		restaurante.cargarInformaciónRestaurante(archivoIngredientes, archivoProductoMenu, archivoCombos, archivoBebidas);
	...
	public static void iniciarPedido() {
			...
			System.out.println("4. Ingredientes Adicionales");
			...
			if (option == 1) {
				...
				int optionIngre = Integer.parseInt(input("\nDigite el número de la bebida "));

				if (optionIngre <= bebidas.size() && optionIngre > 0) {
					
					pedido.agregarBebida(bebidas.get(optionIngre-1));

					System.out
							.println("\n" + bebidas.get(optionIngre - 1).getNombre() + " Agregado correctamente");
